...
const Contact = () => {
    return (
        <section className=' flex flex-col md:flex-row  px-5    bg-secondary ' id="contact">
            ...
            <div className='  md:w-1/2 pr-[20px] flex flex-col mr-15 md:justify-center pl-[100px]  '>
            <h className='font-bold text-white text-2xl md:text-4xl pt-[50px] border-b-4 border-black w-[120px] md:w-[160px]  '> CONTACT</h>
             ...
             <p className='font-bold text-white md:text-2xl pb-[20px]'><span className='font-bold contact-color'>EMAIL=</span>sabarisankar1212@gmail</p>
